(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider-choose")) new swiper_core_Swiper(".slider-choose", {
                ...
                navigation: {
                    prevEl: ".slider-choose__btn_prev",
                    nextEl: ".slider-choose__btn_next"
                },
                on: {}
            });
        ...
        registerLink.addEventListener("click", (() => {
            wrapper.classList.add("_active-register");
        }));
        loginLink.addEventListener("click", (() => {
            wrapper.classList.remove("_active-login");
        }));
        window["FLS"] = true;
        isWebp();
        menuInit();
